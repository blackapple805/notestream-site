...
import { FiX, FiCheck, FiMic, FiTrash2, FiSave, FiCopy } from "react-icons/fi";
  ...
  const [recordings, setRecordings] = useState([
    {
      ...
      duration: 245,
      transcription: "Discussed Q4 goals including increasing user engagement by 25%. Key action items: redesign onboarding flow, implement new analytics dashboard, and launch referral program by end of October.",
    ...
    },
    {
      ...
      duration: 180,
      transcription: "Voice command integration could be huge. Users want hands-free note taking while driving or cooking. Also consider real-time collaboration features and better mobile experience.",
    ...
    },
    {
      ...
      duration: 32,
      transcription: "Remember to follow up with the design team about the new dashboard layout before Friday's review meeting.",
    ...
    <div className="space-y-6 pb-[calc(var(--mobile-nav-height)+24px)] animate-fadeIn">
      ...
      <header className="pt-2 px-1">
        ...
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-theme-primary">Voice Notes</h1>
            <p className="text-theme-muted text-sm">Record and transcribe voice memos with AI</p>
          </div>
        </div>
      </header>
        ...
        <div className="flex flex-col items-center py-6">
          ...
          {isRecording && (
            <div className="flex items-center gap-2 mb-4">
              <span className={`w-2 h-2 rounded-full ${isPaused ? "bg-amber-500" : "bg-rose-500 animate-pulse"}`} />
          ...
          {isTranscribing && (
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm text-theme-muted">Transcribing with AI...</span>
            </div>
          )}
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-emerald-500">Transcription Complete</span>
              </div>
              <div className="flex items-center gap-2">
                <button
                  onClick={() => setIsEditing(!isEditing)}
                  className={`p-2 rounded-lg transition ${isEditing ? "bg-purple-500/20 text-purple-400" : "hover:bg-white/5 text-theme-muted"}`}
                >
                ...
                >
                  {copiedId === "current" ? <FiCheck size={16} className="text-emerald-400" /> : <Copy size={16} />}
                </button>
              </div>
            </div>
            ...
            {isEditing ? (
              ...
              <p className="text-sm text-theme-secondary leading-relaxed p-3 rounded-xl" style={{ backgroundColor: "var(--bg-input)" }}>
                {editedTranscription}
              </p>
            )}
      ...
      <GlassCard>
        ...
        {recordings.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-xs text-theme-muted mt-1">Start recording to see your voice notes here</p>
          </div>
        ) : (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-theme-primary">{recording.title}</p>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    >
                      {copiedId === recording.id ? <FiCheck size={14} className="text-emerald-400" /> : <FiCopy size={14} />}
                    </button>
                    <button
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-xs font-medium text-theme-muted mb-2 block">Preview</label>
                  <div 
