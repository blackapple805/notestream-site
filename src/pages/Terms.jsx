...
export default function TermsPage() {
  return (
    <section className="min-h-screen px-6 py-24 text-[var(--text-secondary)] max-w-4xl mx-auto leading-relaxed">
      ...
      <p className="mb-6">
        Welcome to <span className="text-indigo-400 font-semibold">NoteStream</span>.
      ...
      <h2 className="text-2xl font-semibold text-white mt-8 mb-3">1. Use of Service</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold text-white mt-8 mb-3">2. Account Responsibilities</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold text-white mt-8 mb-3">3. Data & Privacy</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold text-white mt-8 mb-3">4. Service Modifications</h2>
      <p className="mb-4">
        We may update or improve features at any time, including beta access,
        without prior notice.
      </p>

      <h2 className="text-2xl font-semibold text-white mt-8 mb-3">5. Liability</h2>
      <p className="mb-4">
